...
CREATE TABLE IF NOT EXISTS sales (
  ...
  balance_due REAL NOT NULL CHECK (balance_due >= 0),
  daily_notice TEXT NOT NULL DEFAULT '',
...
CREATE INDEX IF NOT EXISTS idx_sales_customer_number ON sales(customer_number);
